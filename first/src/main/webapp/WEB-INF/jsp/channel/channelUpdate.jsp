...
<body>
	...
	<script type="text/javascript">
		...
		function fn_openChannelList(){
			var comSubmit = new ComSubmit();
			comSubmit.setUrl("<c:url value='/sample/openChannelList.do' />");
			comSubmit.submit();
		}
		
		function fn_updateChannel(){
			var comSubmit = new ComSubmit("frm");
			comSubmit.setUrl("<c:url value='/sample/updateChannel.do' />");
			comSubmit.submit();
		}
		
		function fn_deleteChannel(){
			var comSubmit = new ComSubmit();
			comSubmit.setUrl("<c:url value='/sample/deleteChannel.do' />");
